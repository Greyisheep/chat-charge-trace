...
def create_shop_agent(model: str | None = None) -> LlmAgent:
    ...
    return LlmAgent(
        ...
        tools=[
            ...
            FunctionTool(func=tools.suggest_pairings),
            FunctionTool(func=tools.add_to_cart),
            FunctionTool(func=tools.view_cart),
            FunctionTool(func=tools.remove_from_cart),
            FunctionTool(func=tools.clear_cart),
